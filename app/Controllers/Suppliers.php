...
class Suppliers extends BaseController
{
	...
	public function save()
	{
		...
		if (!$check) {
			$validation = \Config\Services::validation();
			return redirect()->to('/suppliers/add')->withInput()->with('validation', $validation);
		} else {
	...
	public function update()
	{
		...
		if (!$check) {
			$validation = \Config\Services::validation();
			return redirect()->to('/suppliers/edit/' . $this->request->getPost('id'))->withInput()->with('validation', $validation);
		} else {
