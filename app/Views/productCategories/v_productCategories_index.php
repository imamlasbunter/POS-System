                                    ...
                                    <?php else : ?>
                                        ...
                                        foreach ($productCategories as $row) : ?>
                                            <tr>
                                                <th scope="row"><?= $no++; ?></th>
                                                <td><?= $row['category']; ?></td>
                                                <td><a class="btn btn-primary" href="<?= base_url('category/edit/' . $row['id']) ?>">Edit</a>
                                                    <a class="btn btn-danger" href="<?= base_url('category/delete/' . $row['id']) ?> " onclick="return confirm('Are you sure ?')">Delete</a>
                                                </td>
                                            </tr>
