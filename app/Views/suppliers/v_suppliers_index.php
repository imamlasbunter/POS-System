                                    ...
                                    <?php else : ?>
                                        ...
                                        foreach ($supplier as $row) : ?>
                                            <tr>
                                                ...
                                                <td><?= $row['no_telp']; ?></td>
                                                <td><?= $row['address']; ?></td>
                                                <td><a class="btn btn-primary" href="<?= base_url('/suppliers/edit/' . $row['id']) ?>">Edit</a>
                                                    <a class="btn btn-danger" href="/suppliers/delete/<?= $row['id'] ?> " onclick="return confirm('Are you sure ?')">Delete</a>
                                                </td>
                                            </tr>
